        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-shopping-cart"></i>Invoice Management <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{route('invoice_list')}}">invoice Record</a></li>
                 ...
                 <!--   <li><a href="javascript:void(0)"><i class="fa fa-cogs"></i> Profile Management </a></li>
                  <li><a><i class="fa fa-shopping-cart"></i>Order Management <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li><a><i class="fa fa-database"></i> Project Management<span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{route('project_list')}}">All Project</a></li>
                            <li><a href="{{route('project_hide_list')}}">Show Hide Project</a></li>
                            <li><a href="{{route('project_Assign')}}">Project Assign</a></li>
                            <li><a href="{{route('project_list_outstand')}}">Outstanding Project</a></li>
                            <li><a href="{{route('project_status')}}">Project Status</a></li>
